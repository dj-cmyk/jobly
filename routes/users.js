...
/** POST /[username]/jobs/[jobId] { user }  => { applied: [jobId] }
 *
 * Allows users to apply for jobs
 *
 * This returns confirmation that user has applied to specific job id
 *  { applied: [jobId] }
 *
 * Authorization required: login, same user or admin status
 **/
